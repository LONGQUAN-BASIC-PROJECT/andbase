 ...
 */
@SuppressLint("NewApi")
public class AbSlidingTabViewNewChild extends LinearLayout {
     ...
     */
    public AbSlidingTabViewNewChild(Context context) {
        this(context, null);
    }
     ...
     */
    public AbSlidingTabViewNewChild(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//  		FragmentManager mFragmentManager = ((FragmentActivity)this.context).getFragmentManager();
     ...
     */
    public AbSlidingTabViewNewChild(Fragment fragment) {
        ...
        initView();
  		if(VERSION.SDK_INT <= 17){	
  			AbLogUtil.e(AbSlidingTabViewNewChild.class, "AbSlidingTabView(Fragment fragment) 要求最低SDK版本17");
  		    return;
  		}
    ...
    public void initView(){
    	this.setOrientation(LinearLayout.VERTICAL);
 		...
 		if(!(this.context instanceof FragmentActivity)){
 			AbLogUtil.e(AbSlidingTabViewNewChild.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
 		}
    }
